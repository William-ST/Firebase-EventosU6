...
import static pe.sulca.eventos.Comun.eliminarIdRegistro;
...
public class Temas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBoxTeatro = findViewById(R.id.checkBoxTeatro);
        checkBoxCine = findViewById(R.id.checkBoxCine);
        checkBoxFiestas = findViewById(R.id.checkBoxFiestas);

        checkBoxNoRecibirNotificaciones = findViewById(R.id.checkBoxNoRecibirNotificaciones);
        ...
        checkBoxDeportes.setChecked(consultarSuscripcionATemaEnPreferencias(
                getApplicationContext(), "Deportes"));
        checkBoxTeatro.setChecked(consultarSuscripcionATemaEnPreferencias(
                getApplicationContext(), "Teatro"));
        checkBoxCine.setChecked(consultarSuscripcionATemaEnPreferencias(
